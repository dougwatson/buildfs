...
var(
	ErrDoesNotImplement = fmt.Errorf("afero doesn't implement required interface")
	ErrLstatNotPossible = fmt.Errorf("lstat is not possible")
	 DefaultFileMode = os.FileMode(0o644) // will be applied to new pathlib files
	 DefaultDirMode = os.FileMode(0o755) // will be applied to new directories
)
type File struct {
     afero.File
}
